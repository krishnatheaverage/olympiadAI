...
const TELLS = [
    ...
    // Solver-speak phrases — appear in worked solutions but virtually
    // never in AMC/AIME problem statements. Only triggered AFTER a
    // newline so a legitimate use mid-sentence wouldn't trip them.
