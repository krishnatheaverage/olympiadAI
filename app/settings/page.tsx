...
export default function SettingsPage() {
    ...
    // Rendering dynamic sub-sections
                    ...
                    <div className="flex flex-wrap gap-2">
                        {trackOptions.map(t => (
                            <button 
                                key={t.value} 
                                type="button"
                                onClick={() => handleTrackUpdate(t.value as any)}
    ...
    const CoachSection = () => {
        ...
        const ToggleRow = ({ label, hint, value, set }: { label: string; hint: string; value: boolean; set: (v: boolean) => void }) => (
            <div className="row border-t hairline pt-6 pb-2">
                <div>
